...
struct mini_expr
{
    ...
    std::string fun;                     // tag name
    std::vector<mini_expr> terms;        // children
};
...
BOOST_FUSION_ADAPT_STRUCT(
    ...
    (std::string, op)
    (std::string, fun)
    (std::vector<mini_expr>, terms)
)

struct mini_expr_parser : qi::grammar<std::string::const_iterator, mini_expr(), qi::locals<std::string>, ascii::space_type>
{
  mini_expr_parser() : mini_expr_parser::base_type(xml)
  {
    using qi::eps;
    using qi::lit;
    using qi::_val;
  ...
  qi::rule<std::string::const_iterator, mini_expr(), qi::locals<std::string>, ascii::space_type> xml;

  qi::rule<std::string::const_iterator, std::string(), ascii::space_type> oper;
  qi::rule<std::string::const_iterator, std::string(), ascii::space_type> name;
};
