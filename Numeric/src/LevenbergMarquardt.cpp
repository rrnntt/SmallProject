...
DECLARE_FUNCMINIMIZER(LevenbergMarquardt)
...
void LevenbergMarquardt::initialize(ICostFunction_sptr function)
{
  m_leastSquares = boost::dynamic_pointer_cast<LeastSquares>(function);
  if ( !m_leastSquares )
  {
...
/// Do one iteration.
bool LevenbergMarquardt::iterate()
{
...
double LevenbergMarquardt::costFunctionVal()
{
  if ( !m_leastSquares )
  {
    throw std::runtime_error("Cost function isn't set up.");
