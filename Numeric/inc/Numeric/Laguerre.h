...
public:
  ...
  virtual std::vector<std::string> getAttributeNames()const{return std::vector<std::string>(1,"n");}
  ...
  virtual bool hasAttribute(const std::string& attName)const { return attName == "n";}
protected:
