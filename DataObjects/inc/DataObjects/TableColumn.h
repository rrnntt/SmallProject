#ifndef DATAOBJECTS_TABLECOLUMN_H
#define DATAOBJECTS_TABLECOLUMN_H
...
#define DECLARE_TABLECOLUMN(DataType,TypeName) \
    ...
    (DataObjects::ColumnFactory::instance().subscribe< DataObjects::TableColumn< DataType > >(#TypeName),0)); \
    }

#define DECLARE_NUMERICTABLECOLUMN(DataType,TypeName) \
    namespace{ \
    int register_numeric_table_column_##TypeName(  \
    (DataObjects::ColumnFactory::instance().subscribe< DataObjects::NumericTableColumn< DataType > >(#TypeName),0)); \
    }

#endif // DATAOBJECTS_TABLECOLUMN_H
