 ...
 */
IFunction::Attribute Chebyshev::getAttribute(const std::string& attName)const
{
  if (attName == "n")
  {
 ...
 */
void Chebyshev::setAttribute(const std::string& attName,const IFunction::Attribute& att)
{
  if (attName == "n")
