#ifndef NUMERIC_DERIVMINIMIZERMINIMIZER_H_
#define NUMERIC_DERIVMINIMIZERMINIMIZER_H_
...
*/
class NUMERIC_EXPORT DerivMinimizer : public IFuncMinimizer
{
public:
  /// Constructor
  DerivMinimizer();
...
protected:
  ...
  ICostFunction_sptr m_costFunction;
